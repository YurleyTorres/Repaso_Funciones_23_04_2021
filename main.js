...
// declaración
// function saludar(p1,p2){
//     console.log(arg);
//     return `Hola ${arg} como estas`; 
// }


// console.log(saludar(23));
...
//     return `Hola ${Callbacks("Marly")} esto es callbacks`;
// }
...
// (function (p1){ 
//     console.log(`Hola ${p1} como estas esto es una funcion autoejecutable`);
// })("Marly Yurley Torres");

// const lista = (function (){
//     let data = [];
//     return function (p1=data){
//         if(typeof(p1)=="object"){
//             data = p1;
//         }else{
//             data.push(p1);
